...
/**
 * Connect with server to get the xml of arrival flight
 * @author Team04
 */
public class GetAvFlights {
	/**
	 * Use HttpUrlConnection to interact with the server 
	 * @param ticketAgency 
	 * @param airportCode The code of each airport
	 * @param day The arrival date of each flight
	 * @return
	 */
	public String getData(String ticketAgency, String airportCode, String day){
		...
		try{
			url = new URL(mUrlBase + QueryFactory.getAvFlights(ticketAgency, airportCode, day));
