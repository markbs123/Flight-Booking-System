...
<title>Duration long to short</title>
<jsp:useBean id="sortByDuration" class="functions.SortByDuration" scope="request"/>
</head>
<body>
<br><br><br>
...
<table style="width:100%">
 ...
 if(returnDay == null){
     ...
     Collections.sort(sortedLine1, sortByDuration);
     Collections.reverse(sortedLine1);
     Collections.sort(sortedLine2, sortByDuration); 
