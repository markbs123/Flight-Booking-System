...
<title>Price high to low</title>
<jsp:useBean id="sortByPrice" class="functions.SortByPrice" scope="request"/>
</head>
<body>
<br><br><br>
...
<table style="width:100%">
 ...
 if(returnDay == null){
     ...
     Collections.sort(sortedLine1, sortByPrice);
     Collections.reverse(sortedLine1);
     Collections.sort(sortedLine2, sortByPrice); 
     ...
     <h2 align="center" style="color:white">Flights taking off between <%=dpMinTimeStr%>---<%=dpMinTimeStr%>, landing between<%=avMinTimeStr%>---<%=avMaxTimeStr%></h2>	
     <%}
 }
 else if(param != null){
     ...
     if(dpMinTimeStrOut != null){ %>
    	 <h2 align="center" style="color:white">Flights taking off between <%=dpMinTimeStrOut%>---<%=dpMinTimeStrOut%>, landing between<%=avMinTimeStrOut%>---<%=avMaxTimeStrOut%></h2>
     <%}%>
