...
<title>Landing Time early to late</title>
<jsp:useBean id="sortByLandingTime" class="functions.SortByLandingTime" scope="request"/>
</head>
<body>
<br><br><br>
...
<table style="width:100%">
 ...
 if(returnDay == null){
     ...
     Collections.sort(sortedLine1, sortByLandingTime);
     Collections.sort(sortedLine2, sortByLandingTime); 
